...
try:
    from sgl_kernel_esimd import flash_ops
except:
    raise ImportError("Can not import sgl_kernel_esimd. Please check your installation.")
...
def flash_attn_with_kvcache(
    ...
    out, softmax_lse, *rest = torch.ops.sgl_kernel_esimd.fwd.default(
        q,
        k_cache,
        v_cache,
        k,
