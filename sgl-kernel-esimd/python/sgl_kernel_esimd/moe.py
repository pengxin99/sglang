...
def moe_align_block_size(
    ...
    torch.ops.sgl_kernel_esimd.moe_align_block_size.default(
        topk_ids,
        num_experts,
        block_size,
        sorted_token_ids,
...
def topk_softmax(
    ...
    torch.ops.sgl_kernel_esimd.topk_softmax.default(
...
def moe_fused_gate(
    ...
    return torch.ops.sgl_kernel_esimd.moe_fused_gate.default(
        input_tensor,
        bias,
        num_expert_group,
        topk_group,
...
def fp8_blockwise_scaled_grouped_mm(
    ...
    torch.ops.sgl_kernel_esimd.fp8_blockwise_scaled_grouped_mm.default(
        output,
        a,
        b,
        scales_a,
